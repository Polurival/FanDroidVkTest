package com.polurival.fandroidvktest.event;
...
public class UploadPhotoEventOnSubscribe implements ObservableOnSubscribe<VKApiPhoto> {
    ...
    public void subscribe(@NonNull ObservableEmitter<VKApiPhoto> e) throws Exception {
        ...
        VKApi.uploadWallPhotoRequest(new VKUploadImage(bitmap, VKImageParameters.pngImage()),
                Integer.parseInt(VKAccessToken.currentToken().userId), 0)
