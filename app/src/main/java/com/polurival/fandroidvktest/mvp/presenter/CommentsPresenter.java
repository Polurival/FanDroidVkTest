...
import com.polurival.fandroidvktest.rest.model.request.WallGetCommentsRequestModel;
...
public class CommentsPresenter extends BaseFeedPresenter<BaseFeedView> {
    ...
    public Observable<BaseViewModel> onCreateLoadDataObservable(int count, int offset) {
        return mWallApi.getComments(new WallGetCommentsRequestModel(Integer.parseInt(mPlace.getOwnerId()),
